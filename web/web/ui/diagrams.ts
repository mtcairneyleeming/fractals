...
export function setupDiagrams() {
    ...
    getInput("num_layers").addEventListener("change", drawLayers)
    getInput("draw_axiom_check").addEventListener("change", drawLayers)
    getInput("layer_dist").addEventListener("change", drawLayers)
    drawCurve()
    updateEverywhere()
    drawParallel()
    drawLayers()
